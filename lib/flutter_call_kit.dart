  ...
  Future<dynamic> _handleMethod(MethodCall call) async {
    ...
    switch (call.method) {
      ...
      case "didDisplayIncomingCall":
        Map map = call.arguments.cast<String, dynamic>();
        return _didDisplayIncomingCall?.call(
            map["error"],
            map["callUUID"],
            map["handle"],
      ...
      case "didPerformSetMutedCallAction":
        Map map = call.arguments.cast<String, dynamic>();
        return _didPerformSetMutedCallAction?.call(
            map["muted"], map["callUUID"]);
      case "didPerformDTMFAction":
        Map map = call.arguments.cast<String, dynamic>();
        return _didPerformDTMFAction?.call(map["digits"], map["callUUID"]);
      case "didToggleHoldAction":
        Map map = call.arguments.cast<String, dynamic>();
        return _didToggleHoldAction?.call(map["hold"], map["callUUID"]);
      case "handleStartCallNotification":
        Map map = call.arguments.cast<String, dynamic>();
        return _handleStartCallNotification?.call(map["handle"], map["video"]);
      default:
